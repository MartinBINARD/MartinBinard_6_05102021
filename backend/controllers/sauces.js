    ...
    switch(req.body.like) {
        ...
        case 0 :
            ...
            if(Sauce.usersLiked.includes(req.body.userId)) {
                Sauce.findOne({ _id: req.params.id }, { $inc: { likes: -1 }, $pull:{ usersLiked: req.body.userI} })
                ...
                Sauce.findOne({ _id: req.params.id }, { $inc: { dislikes: -1 }, $pull: { usersDisliked: req.boduserId } })
